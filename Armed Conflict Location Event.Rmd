...
summary(fe.lnmilitary)
summary(fe.lnsocial)
``` 

```{r regression table, include=FALSE, echo=FALSE}
stargazer(fe.lnmilitary, fe.lnsocial, type = "html",
          title            = "Table 1.",
          covariate.labels = c("Facebook penetration(%)", "GDP per capita (log)"),
          dep.var.caption  = "Conflict type",
          column.labels = c("Armed Group Conflict", "Civilian Coflict")
)
```
